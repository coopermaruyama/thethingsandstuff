...
class Atwix_UniversalAnalytics_Helper_Data extends Mage_Core_Helper_Abstract
{
    /**
     * Config paths for using throughout the code
     */
    const XML_PATH_ACTIVE  = 'google/u_analytics/active';
    const XML_PATH_ACCOUNT = 'google/u_analytics/account';
     ...
     * @return bool
     */
    public function isUniversalGoogleAnalyticsAvailable($store = null)
    {
