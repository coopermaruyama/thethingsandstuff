 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', '3120MacT!');
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'https://github.com/coopermaruyama/thethingsandstuff.git');
 ...
 */
define('TARGET_DIR', '/var/www/thethingsandstuff.com/html/');
